...
#FIX:Network Indicator Disapear In Debian
...
cp -r ./Script/*/ ~/.local/share/kwin/scripts/

#Enable KWin Scripts Configure Button
mkdir -p ~/.local/share/kservices5/
ln -sf ~/.local/share/kwin/scripts/Manual_Tiling_WM/metadata.desktop ~/.local/share/kservices5/Manual_Tiling_WM.desktop
